...
TEXT_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "Aktive Aufträge": {"en": "Active jobs", "es": "Trabajos activos", "pt": "Tarefas ativas"},
    "Alle": {"en": "All", "es": "Todos", "pt": "Todos"},
    "Läuft jetzt": {"en": "Running now", "es": "En curso ahora", "pt": "Em execução agora"},
    "Wartet": {"en": "Waiting", "es": "En espera", "pt": "Em espera"},
    "Aufmerksamkeit": {"en": "Needs attention", "es": "Necesita atención", "pt": "Precisa de atenção"},
    "Blockiert": {"en": "Blocked", "es": "Bloqueado", "pt": "Bloqueado"},
    "Fehler": {"en": "Failed", "es": "Error", "pt": "Falhou"},
    ...
    "Auftrag löschen": {"en": "Delete job", "es": "Eliminar trabajo", "pt": "Excluir tarefa"},
    ...
    "Auftrag, Profil oder Buch suchen": {
        "en": "Search job, profile or book",
        "es": "Buscar trabajo, perfil o libro",
        "pt": "Buscar tarefa, perfil ou livro",
    },
    ...
    "Abschluss & fertige Hörbücher": {"en": "Finalization and finished audiobooks", "es": "Finalización y audiolibros terminados", "pt": "Finalização e audiolivros concluídos"},
    "Abschluss: Metadaten & Tags": {"en": "Finalization: metadata and tags", "es": "Finalización: metadatos y etiquetas", "pt": "Finalização: metadados e tags"},
